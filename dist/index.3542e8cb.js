...
})({"jlY1x":[function(require,module,exports) {
...
(0, _weather.getWeather)().then((weatherData)=>{
    (0, _weather.renderWeather)(weatherData);
}).catch((err)=>{
    console.error(err);
    alert("Error getting weather");
});

},{"./weather":"lwRzY"}],"lwRzY":[function(require,module,exports) {
...
function getWeather() {
    ...
    return (0, _axiosDefault.default).get("https://api.open-meteo.com/v1/forecast?", {
        params
    }).then(({ data })=>{
        return {
...
function parseCurrentWeather({ current, daily }) {
    const { temperature_2m: currentTemp, weather_code: iconCode, time } = current;
    return {
        time,
...
function parseHourlyWeather({ hourly, current }) {
    return hourly.time.map((time, index)=>{
        return {
            ...
            humanCode: parseHumanWeatherCode(hourly.weather_code[index]),
...
},{"axios":"jo6P5","./styles.css":"lW6qc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}]},["jlY1x","8lqZg"], "8lqZg", "parcelRequireef31")
